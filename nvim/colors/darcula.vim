...
hi VertSplit ctermfg=60 ctermbg=NONE cterm=NONE guifg=#555555 guibg=#323232 gui=NONE
hi MatchParen ctermfg=173 ctermbg=NONE cterm=underline guifg=#c57825 guibg=NONE gui=underline
hi StatusLine ctermfg=67 ctermbg=NONE cterm=bold guifg=#a9b7c6 guibg=#323232 gui=bold
hi StatusLineNC ctermfg=188 ctermbg=NONE cterm=NONE guifg=#a9b7c6 guibg=#323232 gui=NONE
...
hi SpecialKey ctermfg=250 ctermbg=NONE cterm=NONE guifg=#bfbfbf guibg=#313335 gui=NONE
...
hi SignColumn ctermfg=60 ctermbg=NONE cterm=NONE guifg=#888888 guibg=#323232 gui=NONE
hi LineNr ctermfg=60 ctermbg=NONE cterm=NONE guifg=#888888 guibg=#323232 gui=NONE
